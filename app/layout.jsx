...
export const metadata = {
  ...
  description: 'Luxury day spa in Cascade (Fort Ritchie), MD. Massage, hair styling, infrared sauna, spa packages, and wellness services. Curated packages for couples, groups, and bridal parties. Serving Hagerstown, Thurmont, Emmitsburg, Frederick, Waynesboro, Chambersburg & surrounding areas.',
  metadataBase: new URL('https://thespasynergy.com'),
  alternates: { canonical: '/' },
  openGraph: {
    title: 'The Spa Synergy | Day Spa in Cascade & Fort Ritchie, MD',
    description: 'Premium spa, massage, hair, wellness services, and curated spa packages in Cascade (Fort Ritchie), MD. Serving Washington County and the tri-state area.',
    type: 'website',
    locale: 'en_US',
...
const jsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Head Spa & Scalp Facials' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Spa Packages & Wellness Bundles' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Couples Spa Packages' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Bridal Party & Group Spa Experiences' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Private Spa Room Services' } },
    ],
  },
  sameAs: [],
}
